...
function Faqs() {
  return (
    <div className="relative h-auto bg-[#e9f4ff] flex flex-col items-center justify-center px-6 py-16">
      <h1 className="text-5xl font-bold mb-12 text-center text-black/90">
        FAQs
      </h1>

      <div className="w-3/5 max-w-6xl flex flex-col gap-4 items-stretch">
        {faqs.map((data, id) => (
          <div key={id} className="flex items-start gap-[15px] w-full">
            ...
            <div className="text-black/90 font-medium shadow-sm text-md leading-snug bg-white px-6 py-4 rounded-2xl flex-grow">
              {data}
            </div>
          </div>
        ))}
