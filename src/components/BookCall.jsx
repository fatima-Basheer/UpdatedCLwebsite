...
function BookCall({ onClose }) {
  return (
    <div className="mx-5 ">
      ...
      <div className="w-full md:w-[55vw] h-[90vh] md:h-[90vh] flex flex-col bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden relative pt-3 my-10">
        {onClose && (
          <button
            type="button"
            onClick={onClose}
          ...
          <div className="space-y-4 md:space-y-5 flex-1">
            ...
            <div className="flex flex-col flex-1 min-h-[100px]">
              ...
              <textarea
                ...
                placeholder="Type here"
                required
                className="text-sm w-full border border-gray-300 p-2.5 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all flex-1 min-h-[90px] resize-none"
              />
            </div>
          </div>
