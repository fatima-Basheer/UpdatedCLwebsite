  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 px-4 sm:px-6 md:px-4 lg:px-6 xl:px-12 pb-4 py-4">
      <div className="w-full max-w-[1200px] mx-auto flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-8 border-2 border-white/30 px-6 py-3 rounded-full text-sm text-black/70 bg-white/30 backdrop-blur-2xl shadow-xl/20 font-medium">
