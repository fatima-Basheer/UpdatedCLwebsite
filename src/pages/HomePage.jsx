...
function HomePage() {
  ...
  return (
    <div
      ref={container}
      className="relative min-h-[700px] overflow-hidden bg-blue-100"
    >
...
"
        ...
        <h1 className="text-black/90 text-5xl font-semibold leading-[1.2]">Engineering AI-Powered <br></br>Software That Works For <br></br>You.</h1>
