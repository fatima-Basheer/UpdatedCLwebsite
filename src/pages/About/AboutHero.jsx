...
function AboutHero() {
  return (
    <section className="relative min-h-fit h-auto overflow-hidden bg-[#e9f4ff] px-4 sm:px-8 md:px-12 lg:px-16 py-20 sm:py-20 md:py-32 2xl:py-40 flex flex-col justify-center items-start sm:items-center isolate">
      ...
      <div className="relative z-10 flex flex-col items-start sm:items-center text-left sm:text-center max-w-4xl mx-0 sm:mx-auto gap-4 mt-6">
        ...
        <div className="flex flex-col gap-2 mt-2">
          ...
          <p className="text-xs text-slate-600 max-w-2xl mx-0 sm:mx-auto">
            At CacheLogics, we believe technology should adapt to your vision –
            not the other way around.
          </p>
    
          <p className="text-xs text-slate-600 max-w-3xl mx-0 sm:mx-auto">
